            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl bg-white shadow-lg md:flex">
                    ...
                    <div className="flex flex-col justify-center p-8 md:w-1/2 lg:p-10">
                        ...
                        >
                            A good for 6 people house designed for a relaxing
                            escape, surrounded by pine trees, peaceful scenery,
                            and the beauty of nature, with its own exclusive swimming pool.
                        </p>
